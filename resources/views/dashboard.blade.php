    ...
    <div class="row">
        <div class="col-lg-10 col-sm-10 col-12 offset-lg-1 offset-sm-1">
            <nav class="navbar navbar-expand-lg bg-info rounded">
                <a class="navbar-brand text-light" href="#">{{\Illuminate\Support\Facades\Auth::user()->name}}</a>
                    ...
                    <ul class="nav nav-pills mr-auto justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link text-light" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-bell">{{ \Illuminate\Support\Facades\Auth::user()->unreadNotifications->count()  }}</i>
                            </a>
